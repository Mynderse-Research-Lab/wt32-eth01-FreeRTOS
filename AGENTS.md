...
Motion control (`Gantry`), Layer-2 closed cell transport (`CellNetL2`), and EtherNet/IP originator
(`EtherNetIP`) share one ESP32. **Production motion is EtherNet/IP only**
(W5500 $\rightarrow$ Kinetix X/Z and Rexroth HCS01 Theta).
...
lib/          ESP-IDF components (Gantry, EtherNetIP, CellNetL2, EthernetLink, W5500, ...)
...
| Layer-2 real-time protocol | `docs/CELL_NET_L2_COMMUNICATION_GUIDE.md` |
| Kinematics & target timing | `docs/PICK_SCHEDULER_KINEMATICS.md` |
| Firmware review & quality | `docs/FIRMWARE_REVIEW_AND_OPTIMIZATIONS.md` |
| Bring-up status, open defects | `docs/DEV_TRACKER.md` |
| Architecture roadmap | `docs/DEVELOPMENT_ROADMAP.md` |
